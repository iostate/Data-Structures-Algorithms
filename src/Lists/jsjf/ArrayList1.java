 ...
 * @version 4.0
 */
public abstract class ArrayList1<T> implements ListADT<T>, Iterable<T>
{
    ...
    protected void expandCapacity()
    {
       ...
       /*
       Ideas: Store current elements into an array. Create new array with
       double the capacity. Copy the elements from to the new array. Done.
        */

       T[] newArray = (T[]) (new Object[list.length * 2]);

       for ( int scan = 0; scan < list.length; scan++ ) {
            newArray[scan] = list[scan];
       }
